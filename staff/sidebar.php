...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-item sidebar-hug flex-col h-60 mb-4">
      ...
      <p class="text-lg font-bold">Staff</p>
    ...
    <a href="staffSubmission.php">
      <div class="sidebar-item items-center flex flex-row justify-start items-center <?php echo basename($_SERVER['PHP_SELF']) == 'staffSubmission.php' ? 'bg-blue-100' : ''; ?> gap-4">
