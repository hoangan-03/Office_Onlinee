...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="headManagement.php">
      <div class="sidebar-item items-center flex flex-row justify-start items-center <?php echo basename($_SERVER['PHP_SELF']) == 'headManagement.php' ? 'bg-blue-100' : ''; ?> gap-4">
    ...
    <a href="headSubmission.php">
      <div class="sidebar-item items-center flex flex-row justify-start items-center <?php echo basename($_SERVER['PHP_SELF']) == 'headSubmission.php' ? 'bg-blue-100' : ''; ?> gap-4">
        <img alt="calendar" class="sidebar-logo w-2 h-2 object-cover" src="../assets/task2.png" />
